...
class GroundedTextImageDataset_Grounding(Base):
    def __init__(self, json_path, image_root, chunk_idx, total_chunk):
        ...
        self.text_annotations = json_raw["text_anno"]
        ...
        #print('change self.data',self.data)
    def __getitem__(self, index):
        ...
        caption = self.data[ anno["data_id"]  ]["caption"]
        file_name = self.data[ anno["data_id"]  ]["file_name"]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_path", type=str,  default="./example.json", help="")
    parser.add_argument("--image_root", type=str,  default="./image_example/", help="")
