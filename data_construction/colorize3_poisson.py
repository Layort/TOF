...
# from get_text_color import get_color
...
class FontColor(object):
    ...
    def sample_from_data(self, bg_mat):
        ...
        # colors = []
        # colors.append(tuple(col1))
        # colors.append(tuple(col2))
        # print('colors',colors)
  
        # col_name = get_colors(colors)
        # print('col1_name',col_name[0])
        # print('col2_name',col_name[1])
...
class Colorize(object):
    ...
    def __init__(self, model_dir='data'):  # , im_path):
        ...
        self.p_drop_shadow = 0 #0.5
        self.p_border =  1 # 0.05
        self.p_displacement = 1 # 0.30  # add background-based bump-mapping
    ...
    def process(self, text_arr, bg_arr, min_h):
        ...
        # plt.subplot(1, 3, 1)
        # plt.imshow(l_normal.color)
        # plt.title('l_normal.color')

        # plt.subplot(1, 3, 2)
        # plt.imshow(l_bg.color)
        # plt.title('l_bg.color')
    ...
    def color(self, bg_arr, text_arr, hs, place_order=None, pad=20):
        ...
        for i in place_order[::-1]:
            ...
            rdr0,fg_col, bg_col  = self.process(text_patch, bg, hs[i])
            rendered.append(rdr0)

            bg_arr[l[0]:l[0] + w, l[1]:l[1] + h, :] = rdr0  # rendered[-1]
     
            return bg_arr,fg_col, bg_col 
