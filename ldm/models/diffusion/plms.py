    ...
    def p_sample_plms(self, input, t, index, guidance_scale=1., uc=None, old_eps=None, t_next=None):
        ...
        def get_model_output(input):
            ...
            if uc is not None and guidance_scale != 1:
                unconditional_input = dict(x=input["x"],hint=input['hint'], timesteps=input["timesteps"], context=uc, inpainting_extra_input=input["inpainting_extra_input"], grounding_extra_input=input['grounding_extra_input'])
